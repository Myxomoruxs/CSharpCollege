    ...
    public partial class ClockForm : Form
    {
        ...
        private void ShowControls()
        {
            Text = _settings.IsAlarmActive ? "Будильник (ожидание)" : "Будильник";
                ...
                private void ResetAlarmSettings()
        {
            _settings.AlarmTime = new TimeSpan(7, 0, 0); // Установим время будильника на 7:00
            _settings.AlarmMessage = "Пора вставать!"; // Сообщение по умолчанию
            _settings.IsAlarmActive = false; // Будильник выключен
            _settings.IsSoundActive = true; // Звуковой сигнал включен
            ShowControls(); // Обновим отображение
        }
    }
}
